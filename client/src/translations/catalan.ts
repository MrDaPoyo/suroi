...
export const ENGLISH_TRANSLATIONS: TranslationMap = {
    ...
    "msg_rotate": "Per una millor experiéncia, si us plau, roti el seu dispositiu horitzontalment.",
    "msg_loading": "Connectant",
    "msg_err_joining": "Error al unir-se al joc.",
    "msg_err_finding": "Error al trobar al joc.",
    "msg_try_again": "Si us plau, provi un altre cop.",
    "msg_warning": "Has estat avisat!",
    "msg_warning_msg": "Has rebut un avis dels moderadors per: <reason>",
    "msg_temp_ban": "Has sigut restringit temporalment",
    "msg_temp_ban_msg": "Has sigut restringit per: <reason>",
    "msg_perma_ban": "Has sigut restringit permanentment!",
    "msg_perma_ban_msg": "Has sigut restringit per: <reason>",
    "msg_no_reason": "Ninguna raó provinguda.",

    "play_solo": "Juga Solo",
    "play_duo": "Juga Duos",
    "play_squad": "Juga Esquadrons",
    "join_team": "Uneix-te a Equip",
    "msg_locked_tooltip": "El joc intercala Solos i Duos cada 24 hores, degut a la falta de jugadors per als dos.",
    ...
    "settings_require_reload": "* Cambiant qualsevol d'aquestes configuracions requireix recàrregar la pàgina web",
    "settings_performance_warning": "* Aquesta configuració pot provocar problemes en alguns dispositius. Deshabilita-ho si no pots unir-te al joc.",

    "settings_master_volume": "Volum Màster",
    "settings_sfx_volume": "Volum d'SFX",
    "settings_music_volume": "Volum de la Música",
    "settings_old_menu_music": "Musica del menú antic",
    ...
    "lewis_gun": "Lewis Gun",
    "deathray": "Death Ray",
    "firework_launcher": "Llençador de ",
